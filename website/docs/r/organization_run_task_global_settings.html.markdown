---
layout: "stackweaver"
page_title: "Stackweaver: stackweaver_organization_run_task_global_settings"
description: |-
...
The stackweaver_organization_run_task_global_settings resource creates, updates and destroys the [global settings](https://developer.hashicorp.com/terraform/cloud-docs/workspaces/settings/run-tasks#global-run-tasks) for an [Organization Run task](https://developer.hashicorp.com/terraform/cloud-docs/workspaces/settings/run-tasks#creating-a-run-task). Your organization must have the `global-run-task` [entitlement](https://developer.hashicorp.com/terraform/cloud-docs/api-docs#feature-entitlements) to use global run tasks.
...
```hcl
resource "stackweaver_organization_run_task_global_settings" "example" {
  task_id = stackweaver_organization_run_task.example.id
  enabled           = true
...
```shell
terraform import stackweaver_organization_run_task_global_settings.test my-org-name/task-name
```
